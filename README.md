...
WHERE td."ОПЕРАЦИИ" IN (SELECT "ИДЕНТИФИКАТОР" FROM "ТИПЫ ОПЕРАЦИЙ" WHERE "НАИМЕНОВАНИЕ" LIKE '%Инъекция%')
```
TODO: МЕДПЕРСОНАЛ повторяется((
